                ...
                <div class="card-body">
                    ...
                    <form action="{{route('new-brand')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="brand_name" class="form-control" id="horizontal-firstname-input">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-email-input" class="col-sm-3 col-form-label">Brand Descraption</label>
                            <div class="col-sm-9">
                                <textarea  name="brand_descraption" class="form-control" id="horizontal-email-input"> </textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                        ...
                        @foreach($brands as $brand)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('delete-brand',['id'=> $brand->id])}}" onclick="return confirm('Are You Sure Delete This...')" class="btn btn-danger btn-sm">
