                ...
                <div class="card-body">
                    ...
                    <form action="{{route('update-category')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="cat_name" value="{{$category->CatName}}" class="form-control" id="horizontal-firstname-input">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea  name="cat_descraption" class="form-control" id="horizontal-email-input">{{$category->catDescraption}} </textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img src="{{asset(asset($category->catImage))}}" height="80" width="120" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" {{$category->catStatus==1?'checked':''}} type="radio" checked name="status" id="inlineRadio1" value="1">
                                    <label class="form-check-label" for="inlineRadio1">Publish</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" {{$category->catStatus==0?'checked':''}} type="radio" name="status" id="inlineRadio2" value="0">
