            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="ecommerce-products.html">Manage User</a></li>
                        <li><a href="ecommerce-product-detail.html">Manage user Role</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="projects-grid.html">New inventory</a></li>
                        <li><a href="projects-list.html">Manage inventory</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="tasks-list.html">Manage Order</a></li>
                        <li><a href="tasks-kanban.html">Manage Offer</a></li>
                        <li><a href="tasks-create.html">Manage Coupon</a></li>
                    </ul>
                </li>
