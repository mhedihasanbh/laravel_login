                ...
                <div class="card-body">
                    ...
                    <form action="{{route('size.update',$size->id)}}" method="post" >
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" value="{{$size->name}}" class="form-control" id="horizontal-firstname-input">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Size  code</label>
                            <div class="col-sm-9">
                                <input type="text" name="code" value="{{$size->code}}" class="form-control" id="horizontal-firstname-input">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-email-input" class="col-sm-3 col-form-label">Size  Descraption</label>
                            <div class="col-sm-9">
                                <textarea  name="descraption" class="form-control" id="horizontal-email-input">{{$size->descraption}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" {{$size->status==1?'checked':''}} checked name="status" id="inlineRadio1" value="1">
                                    <label class="form-check-label" for="inlineRadio1">Publish</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" {{$size->status==1?'checked':''}} name="status" id="inlineRadio2" value="0">
